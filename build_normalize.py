...
"klar": dict(domain_category="교육", team_size_bucket="2-3",
    founder_background="unknown", founder_experience="first-time",
    revenue_annual_usd_est=140400, normalize_note="ARR €130K, EUR→USD 1.08 적용."),
"quicktables": dict(domain_category="생산성/업무도구 SaaS", team_size_bucket="4+",
    founder_background="unknown", founder_experience="unknown",
    revenue_annual_usd_est=108000, exit_value_usd=None,
    normalize_note="ARR €100K, EUR→USD 1.08 적용. 인수됐으나 금액 비공개."),
...
"trend-widget": dict(domain_category="커뮤니티/미디어", team_size_bucket="solo",
    founder_background="developer", founder_experience="unknown",
    revenue_annual_usd_est=None, normalize_note="매출 비공개, DAU만 확인."),
"my-askai": dict(domain_category="생산성/업무도구 SaaS", team_size_bucket="2-3",
    founder_background="non-developer", founder_experience="unknown",
    revenue_annual_usd_est=444444, normalize_note="월 5,000만원, KRW→USD 1350 적용 후 연환산."),
"flexiple": dict(domain_category="B2B 대행/컨설팅", team_size_bucket="solo",
    founder_background="unknown", founder_experience="unknown",
    revenue_annual_usd_est=2222222, normalize_note="연 30억원, KRW→USD 1350 적용."),
"formula-bot": dict(domain_category="생산성/업무도구 SaaS", team_size_bucket="solo",
    founder_background="mixed", founder_experience="unknown",
    revenue_annual_usd_est=296296, normalize_note="연 4억원, KRW→USD 1350 적용."),
"ai-coding-consultancy": dict(domain_category="B2B 대행/컨설팅", team_size_bucket="unknown",
    founder_background="unknown", founder_experience="unknown",
    revenue_annual_usd_est=None, normalize_note="매출 비공개, 프로젝트 건수만 확인."),
